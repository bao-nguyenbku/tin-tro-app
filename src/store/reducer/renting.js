...
import {
  getRoomInfoService,
  requestCheckoutRoomService,
  getAllCheckoutRequestService,
  requestCancelCheckoutRoomService,
  acceptCheckoutRoomService,
} from '@/services/renting';
...
export const cancelRequestCheckoutByOwner = createAsyncThunk(
  'renting/cancelRequestCheckoutByOwner',
  async (rentingId, { rejectWithValue, dispatch }) => {
    try {
